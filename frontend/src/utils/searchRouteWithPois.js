...
export async function searchRouteWithPois(from, to, options = {}) {
  try {
    ...
    // ✅ 여기서 콘솔에 카테고리별 POI 정보 출력
    console.log("📦 전체 POI 정보:", poiByCat);
    console.log("☕ 카페 목록:", poiByCat["cafe"]);
    console.log("🏪 편의점 목록:", poiByCat["store"]);
    console.log("🍽 음식점 목록:", poiByCat["food"]);
    console.log("🔌 충전소 목록:", poiByCat["charge"]);

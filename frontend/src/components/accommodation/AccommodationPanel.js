...
const AccommodationPanel = () => {
  ...
  return (
    <div style={{ display: "flex", height: "100vh" }}>
      {/* 숙소 리스트 */}
      <div style={{ width: 340, borderRight: "1px solid #eee", background: "#fff", overflowY: "auto" }}>
        <div style={{ fontWeight: "bold", padding: 16, borderBottom: "1px solid #ddd" }}>전기차 충전소 숙소 목록</div>
